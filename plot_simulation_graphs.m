...
%========================================================================= 
     ...
     title({'Simulated vs. Measured';'Average Speed 1.2 m/s'},'Fontweight','bold','Fontsize',12)
     xlim([200 205])
     subplot(1,2,2)
     hold on
     ...
     ylabel('Pitch Moment (Nm)','fontweight','bold')
     legend('Measured','Simulated')
     title({'Simulated vs. Measured'; 'Average Speed 2.0 m/s'},'Fontweight','bold','Fontsize',12)
     xlim([200 205])
end